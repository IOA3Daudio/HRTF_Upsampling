...
def main():
    ...
    for fold in range(configs.K):
        ...
        itd_valid_true, itd_valid_pred, itd_valid_recon, itd_valid_sparse_in = et.test(net)
        itd_valid_true = itd_valid_true*ori_dataset.itd_std + ori_dataset.itd_mean
        itd_valid_pred = itd_valid_pred*ori_dataset.itd_std + ori_dataset.itd_mean
        itd_valid_recon = itd_valid_recon*ori_dataset.itd_std + ori_dataset.itd_mean
        itd_valid_sparse_in = itd_valid_sparse_in*ori_dataset.itd_std + ori_dataset.itd_mean
        ...
        sio.savemat(configs.out_pth+'valid_data_'+str(fold)+'.mat', {'itd_valid_true':itd_valid_true,
